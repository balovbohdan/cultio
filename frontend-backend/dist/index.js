...
"use strict";
eval("\nObject.defineProperty(exports, \"__esModule\", { value: true });\nvar React = __webpack_require__(/*! react */ \"react\");\nvar ReactDOMServer = __webpack_require__(/*! react-dom/server */ \"react-dom/server\");\nvar Html_1 = __webpack_require__(/*! ./Html */ \"./src/routes/app/Html.tsx\");\nvar Content_1 = __webpack_require__(/*! ./Content */ \"./src/routes/app/Content.tsx\");\nexports.App = function (props) {\n    var state = props.client.extract();\n    var content = createContentStr(props);\n    return React.createElement(Html_1.Html, { state: state, content: content, devMode: props.devMode });\n};\nvar createContentStr = function (_a) {\n    var context = _a.context, client = _a.client, location = _a.location;\n    var content = React.createElement(Content_1.Content, { client: client, context: context, location: location });\n    return ReactDOMServer.renderToString(content);\n};\n\n\n//# sourceURL=webpack:///./src/routes/app/App.tsx?");

/***/ }),

/***/ "./src/routes/app/Content.tsx":
/*!************************************!*\
  !*** ./src/routes/app/Content.tsx ***!
  \************************************/
/*! no static exports found */
...
"use strict";
eval("\nvar __awaiter = (this && this.__awaiter) || function (thisArg, _arguments, P, generator) {\n    return new (P || (P = Promise))(function (resolve, reject) {\n        function fulfilled(value) { try { step(generator.next(value)); } catch (e) { reject(e); } }\n        function rejected(value) { try { step(generator[\"throw\"](value)); } catch (e) { reject(e); } }\n        function step(result) { result.done ? resolve(result.value) : new P(function (resolve) { resolve(result.value); }).then(fulfilled, rejected); }\n        step((generator = generator.apply(thisArg, _arguments || [])).next());\n    });\n};\nvar __generator = (this && this.__generator) || function (thisArg, body) {\n    var _ = { label: 0, sent: function() { if (t[0] & 1) throw t[1]; return t[1]; }, trys: [], ops: [] }, f, y, t, g;\n    return g = { next: verb(0), \"throw\": verb(1), \"return\": verb(2) }, typeof Symbol === \"function\" && (g[Symbol.iterator] = function() { return this; }), g;\n    function verb(n) { return function (v) { return step([n, v]); }; }\n    function step(op) {\n        if (f) throw new TypeError(\"Generator is already executing.\");\n        while (_) try {\n            if (f = 1, y && (t = op[0] & 2 ? y[\"return\"] : op[0] ? y[\"throw\"] || ((t = y[\"return\"]) && t.call(y), 0) : y.next) && !(t = t.call(y, op[1])).done) return t;\n            if (y = 0, t) op = [op[0] & 2, t.value];\n            switch (op[0]) {\n                case 0: case 1: t = op; break;\n                case 4: _.label++; return { value: op[1], done: false };\n                case 5: _.label++; y = op[1]; op = [0]; continue;\n                case 7: op = _.ops.pop(); _.trys.pop(); continue;\n                default:\n                    if (!(t = _.trys, t = t.length > 0 && t[t.length - 1]) && (op[0] === 6 || op[0] === 2)) { _ = 0; continue; }\n                    if (op[0] === 3 && (!t || (op[1] > t[0] && op[1] < t[3]))) { _.label = op[1]; break; }\n                    if (op[0] === 6 && _.label < t[1]) { _.label = t[1]; t = op; break; }\n                    if (t && _.label < t[2]) { _.label = t[2]; _.ops.push(op); break; }\n                    if (t[2]) _.ops.pop();\n                    _.trys.pop(); continue;\n            }\n            op = body.call(thisArg, _);\n        } catch (e) { op = [6, e]; y = 0; } finally { f = t = 0; }\n        if (op[0] & 5) throw op[1]; return { value: op[0] ? op[1] : void 0, done: true };\n    }\n};\nvar _this = this;\nObject.defineProperty(exports, \"__esModule\", { value: true });\nvar React = __webpack_require__(/*! react */ \"react\");\nvar react_apollo_1 = __webpack_require__(/*! react-apollo */ \"react-apollo\");\nvar ReactDOMServer = __webpack_require__(/*! react-dom/server */ \"react-dom/server\");\nvar App_1 = __webpack_require__(/*! ../App */ \"./src/routes/app/App.tsx\");\nexports.createHtml = function (props) { return __awaiter(_this, void 0, void 0, function () {\n    var app;\n    return __generator(this, function (_a) {\n        switch (_a.label) {\n            case 0:\n                app = createApp(props);\n                return [4 /*yield*/, react_apollo_1.getDataFromTree(app)];\n            case 1:\n                _a.sent();\n                return [2 /*return*/, createStr(app)];\n        }\n    });\n}); };\nvar createStr = function (app) {\n    var appStr = ReactDOMServer.renderToStaticMarkup(app);\n    return \"<!doctype html>\\n\" + appStr;\n};\nvar createApp = function (props) {\n    return React.createElement(App_1.App, { client: props.client, devMode: props.devMode, context: props.context, location: props.location });\n};\n\n\n//# sourceURL=webpack:///./src/routes/app/utils/html-creator.tsx?");
...
"use strict";
eval("\nObject.defineProperty(exports, \"__esModule\", { value: true });\nvar html_creator_1 = __webpack_require__(/*! ./html-creator */ \"./src/routes/app/utils/html-creator.tsx\");\nexports.createHtml = html_creator_1.createHtml;\n\n\n//# sourceURL=webpack:///./src/routes/app/utils/index.ts?");
